...
__name(W, "W");
function Z() {
  globalThis[X] || (ye(), globalThis[X] = true);
}
__name(Z, "Z");
function ye() {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.7760496332919975.mjs.map
