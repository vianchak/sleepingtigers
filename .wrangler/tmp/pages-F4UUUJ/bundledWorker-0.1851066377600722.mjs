...
function ye() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return r || (r = await Z(s), r) ? r : (Te(s), e(s));
  };
}
__name(ye, "ye");
async function ve(e) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.1851066377600722.mjs.map
