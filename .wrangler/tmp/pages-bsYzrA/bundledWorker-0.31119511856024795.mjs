...
__name(W, "W");
function Z() {
  globalThis[Q] || (ye(), globalThis[Q] = true);
}
__name(Z, "Z");
function ye() {
...
__name(Te, "Te");
var Q = /* @__PURE__ */ Symbol.for("next-on-pages fetch patch");
u();
l();
p();
var Y = q(X());
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.31119511856024795.mjs.map
