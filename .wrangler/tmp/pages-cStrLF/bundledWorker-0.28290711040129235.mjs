...
function ye() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return r || (r = await Q(s), r) ? r : (Te(s), e(s));
  };
}
__name(ye, "ye");
async function ve(e) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.28290711040129235.mjs.map
