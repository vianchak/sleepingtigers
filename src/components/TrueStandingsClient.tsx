  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold text-gradient">True Standings (All-Play)</h2>
      </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-900/50 text-slate-300 text-sm uppercase tracking-wider">
                ...
                <th className="p-4 font-semibold">Actual Record</th>
                <th className="p-4 font-semibold">All-Play Record</th>
                <th className="p-4 font-semibold">All-Play Win %</th>
                <th className="p-4 font-semibold text-right">PF</th>
                <th className="p-4 font-semibold text-right">PA</th>
              </tr>
            </thead>
                ...
                return (
                  <tr key={result.team.rosterId} className="hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="p-4">
                      ...
                      {isLucky && <span className="ml-2 text-xs text-emerald-400 bg-emerald-400/10 px-2 py-1 rounded-full">Lucky</span>}
                      {isUnlucky && <span className="ml-2 text-xs text-rose-400 bg-rose-400/10 px-2 py-1 rounded-full">Unlucky</span>}
                    </td>
      ...
      <div className="glass-panel p-6">
        <h3 className="text-xl font-bold mb-6 text-slate-200">League Scoring Distribution</h3>
